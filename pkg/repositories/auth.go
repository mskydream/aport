...
// 	var id int
// query := `INSERT INTO user_profile (name, surname, born, phone_number, email, gender, address, password, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW()) RETURNING id`
...
func (r *Repo) SignUp(user *models.UserProfile) (model models.UserProfile, err error) {
	...
	query := `INSERT INTO user_profile (name, surname, born, phone_number, email, gender, address, password, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW()) RETURNING id, name, surname, born, phone_number, email, gender, address, password, created_at`
	row := r.db.DB.QueryRow(query, user.Name, user.Surname, user.Born, user.PhoneNumber, user.Email, user.Gender, user.Address, user.Password)
